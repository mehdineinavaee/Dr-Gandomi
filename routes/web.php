...
Route::resource('blog_left', BlogLeftSidebarController::class);
Route::resource('blog_right', BlogRightSidebarController::class);
...
Route::resource('courses_details', CourseDetailController::class);
...
Route::resource('page404', NotFoundPageController::class);
