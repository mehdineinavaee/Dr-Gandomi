    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="staticBackdropLabel">حذف دسته بندی</h5>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-success badge-pill btn-w btn-sm delete_category_btn">موافقم
                </button>
            </div>
        </div>
    </div>
