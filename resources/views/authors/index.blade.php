...
@section('content')
    @include('common.breadcrumbs', [
        'data' => [['title' => 'مدیریت نویسنده ها', 'url' => url()->current(), 'bg' => $settings->authors]],
    ])
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card border-dark mb-3">
                        <div class="card-header">مدیریت نویسنده ها</div>
                        <div class="card-body text-dark">
                            <h5 class="card-title">
                                <a href="{{ route('authors.create') }}">
                                    <i class="ri-add-circle-fill" style="font-size: 2rem" data-toggle="tooltip"
                                        data-placement="top" title="افزودن نویسنده جدید"></i>
                                </a>
                            </h5>
                            <p class="card-text">
                                    ...
                                    <tbody>
                                        @foreach ($authors as $author)
                                            <tr>
                                                ...
                                                <td style="text-align:center;" class="align-middle">{{ $author->last_name }}
                                                </td>
                                                <td style="text-align:center;" class="align-middle">
                                                    ...
                                                    <button value='/authors/{{ $author->id }}'
