                                    ...
                                    <tbody>
                                        @foreach ($courses as $course)
                                            <tr>
                                                ...
                                                <td style="text-align:center;">{{ $course->mode->title }}</td>
                                                <td style="text-align:center;">{{ $course->duration }}</td>
                                                <td style="text-align:center;">{{ $course->start_dates }}</td>
                                                <td style="text-align:center;">{{ number_format($course->fee) }} تومان</td>
                                                <td style="text-align:center;">{{ $course->language }}</td>
                                                <td style="text-align:center;">{{ $course->seats_available }}</td>
