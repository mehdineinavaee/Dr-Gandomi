                ...
                (this.$ele.innerHTML = r),
                  ...
                  this.hasDropboxWrapper
                    ? ((this.$allWrappers = [
                      ...
                      (this.$dropboxContainer = this.$dropboxWrapper.querySelector(
                  ...
                  (this.$dropbox = this.$dropboxContainer.querySelector(
                    ".vscomp-dropbox"
                  )),
                  (this.$dropboxCloseButton = this.$dropboxContainer.querySelector(
                    ".vscomp-dropbox-close-button"
                  )),
                  (this.$search = this.$dropboxContainer.querySelector(
                    ".vscomp-search-wrapper"
                  )),
                  (this.$optionsContainer = this.$dropboxContainer.querySelector(
                    ".vscomp-options-container"
                  )),
                  (this.$optionsList = this.$dropboxContainer.querySelector(
                    ".vscomp-options-list"
                  )),
                  (this.$options = this.$dropboxContainer.querySelector(
                    ".vscomp-options"
                  )),
                  (this.$noOptions = this.$dropboxContainer.querySelector(
                    ".vscomp-no-options"
                  )),
          ...
          },
          {
            ...
            value: function () {
              ...
              o.forEach(function (o) {
                ...
                (this.$visibleOptions = this.$options.querySelectorAll(
                  ".vscomp-option"
                )),
            ...
            value: function () {
              if (this.hasSearchContainer) {
                ...
                this.multiple &&
                  ...
                  (e = '<span class="vscomp-toggle-all-button">\n          <span class="checkbox-icon vscomp-toggle-all-checkbox"></span>\n          <span class="vscomp-toggle-all-label">'.concat(
                    this.selectAllText,
                    "</span>\n        </span>"
                  )),
                  this.hasSearch &&
                    (t = '<input type="text" class="vscomp-search-input" style="width: 100%" placeholder="'.concat(
                ...
                (this.$search.innerHTML = i),
                  ...
                  (this.$toggleAllCheckbox = this.$dropboxContainer.querySelector(
          ...
          },
          {
            ...
            value: function (e) {
              var t = {
                ...
                optionHeight: "40px",
                noOptionsText: "داده ای وجود ندارد",
                noSearchResultsText: "نتیجه ای یافت نشد",
                selectAllText: "انتخاب همه",
                searchPlaceholderText: "جستجو کنید",
                ...
                if ("" === c) s.innerHTML = this.placeholder;
                  ...
                  if (
                    ...
                    if (
                      ...
                      (s.innerHTML = r.join("")),
                        (this.$valueTags = s.querySelectorAll(
                          ".vscomp-value-tag"
                        )),
